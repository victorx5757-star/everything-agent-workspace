      ...
      <div className="px-5 pb-4 pt-5">
        ...
        <div className="mt-4 grid gap-2 rounded-lg border bg-muted/35 p-3 text-sm">
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <span className="font-medium text-foreground">{t('backlogHint.backlogLabel')}</span>
            <span className="text-muted-foreground">{t('backlogHint.backlogKeepsPaused')}</span>
          </div>
          <div className="flex items-center gap-2 text-muted-foreground">
            <ArrowRight className="size-4 shrink-0" />
            <span className="font-medium text-foreground">{t('backlogHint.todoLabel')}</span>
            <span className="text-muted-foreground">{t('backlogHint.todoStartsAgent')}</span>
      ...
      <div className="border-t bg-muted/25 px-5 py-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <label className="flex min-w-0 cursor-pointer items-center gap-2 text-sm text-muted-foreground">
            ...
            />
            <span className="truncate">{t('backlogHint.dontShowAgain')}</span>
          </label>
