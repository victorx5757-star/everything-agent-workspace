...
// Mapping from nav key to i18n navigation namespace key
const navI18nKey: Record<NavKey, string> = {
  inbox: "inbox",
  myIssues: "myIssues",
  issues: "issues",
  projects: "projects",
    ...
    >
      ...
      >
        ...
        <Tooltip>
          ...
          <TooltipContent side="top" sideOffset={4}>{t('unpin')}</TooltipContent>
        </Tooltip>
      </SidebarMenuButton>
    </SidebarMenuItem>
  );
  ...
  return (
      <Sidebar variant="inset">
        ...
        <SidebarContent>
            ...
            <SidebarGroupContent>
              <SidebarMenu className="gap-0.5">
                {personalNav.map((item) => {
                  ...
                  const isActive = pathname === href;
                  const label = tn(navI18nKey[item.key]);
                  return (
          ...
          <SidebarGroup>
            <SidebarGroupLabel>{tn('workspace')}</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu className="gap-0.5">
                {workspaceNav.map((item) => {
                  ...
                  return (
                    <SidebarMenuItem key={item.key}>
                      ...
                      >
                        <item.icon />
                        <span>{tn(navI18nKey[item.key])}</span>
                      </SidebarMenuButton>
                    </SidebarMenuItem>
                  );
                })}
          ...
          <SidebarGroup>
            <SidebarGroupLabel>{tn('configure')}</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu className="gap-0.5">
