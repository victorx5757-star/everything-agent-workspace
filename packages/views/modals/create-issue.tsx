...
export function CreateIssueModal({ onClose, data }: { onClose: () => void; data?: Record<string, unknown> | null }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
        ...
        toast.custom((toastId) => (
          <div className="bg-popover text-popover-foreground border rounded-lg shadow-lg p-4 w-[360px]">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium">{t("createIssue.created")}</span>
            </div>
      ...
      toast.error(t("createIssue.failedToCreate"));
    } finally {
      setSubmitting(false);
    }
  };
    ...
    >
      ...
      >
        {backlogHintIssueId ? (
          ...
          <>
            <DialogTitle className="sr-only">{t("createIssue.title")}</DialogTitle>
            ...
            <div className="flex items-center justify-between px-5 pt-3 pb-2 shrink-0">
              <div className="flex items-center gap-1.5 text-xs">
                ...
                <span className="font-medium">{data?.parent_issue_id ? t("createIssue.subIssueTitle") : t("createIssue.title")}</span>
              </div>
              <div className="flex items-center gap-1">
                <Tooltip>
                  ...
                  />
                  <TooltipContent side="bottom">{isExpanded ? t("createIssue.collapse") : t("createIssue.expand")}</TooltipContent>
                </Tooltip>
                <Tooltip>
                  <TooltipTrigger
                    render={
                  ...
                  />
                  <TooltipContent side="bottom">{tc("close")}</TooltipContent>
                </Tooltip>
              </div>
            </div>
            ...
            <div className="px-5 pb-2 shrink-0">
              <TitleEditor
                ...
                placeholder={t("createIssue.titleField")}
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t shrink-0">
              ...
              <Button size="sm" onClick={handleSubmit} disabled={!title.trim() || submitting}>
                {submitting ? t("createIssue.creating") : t("createIssue.create")}
              </Button>
            </div>
          </>
        )}
